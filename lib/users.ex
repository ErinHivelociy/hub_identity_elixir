defmodule HubIdentityElixir.Users do
  alias HubIdentityElixir.Users.{Email, Verification}
  ...
  ## Examples
      ...
      iex> HubIdentityElixir.User.get_emails(user_uid)
      {:ok,
      [
        %{
          "Object" => "Email",
  ...
  You have 3 attemps.
  ## Examples
      iex> HubIdentityElixir.User.validate_verification_code(user_uid, reference, valid_code)
        {:ok, %{"ok" => "verification success"}}

      iex> HubIdentityElixir.User.validate_verification_code(user_uid, reference, wrong_code)
        {:error, "{\"error\":\"verification failed\"}"}

      iex> HubIdentityElixir.User.validate_verification_code(user_uid, reference, 3rd_attemp_code)
